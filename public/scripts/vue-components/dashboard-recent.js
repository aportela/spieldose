    ...
    <section class="panel chart">
        ...
        <div class="panel-block">
            <ol v-if="items.length > 0">
                <li class="is-small" v-if="entity == 0" v-for="item, i in items">{{ item.title }}<span v-if="item.artist"> / <a v-bind:href="'/#/app/artist/' + $router.encodeSafeName(item.artist)">{{ item.artist }}</a></span></li>
                ...
                <li class="is-small" v-if="entity == 2" v-for="item, i in items">{{ item.album }}<span v-if="item.artist"> / <a v-bind:href="'/#/app/artist/' + $router.encodeSafeName(item.artist)">{{ item.artist }}</a></span></li>
            </ol>
