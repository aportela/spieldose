<?php
    ...
    (
        ...
        (
            ...
            2 => array(
                " CREATE TABLE IF NOT EXISTS FILE_ID3_TAG(ID CHAR(40) PRIMARY KEY, TITLE VARCHAR(128), ARTIST VARCHAR(128), ALBUM_ARTIST VARCHAR(128), ALBUM VARCHAR(128), YEAR CHAR(4), MB_ARTIST_ID CHAR(36), MB_ALBUM_ID CHAR(36)); "
            ),
            3 => array(
