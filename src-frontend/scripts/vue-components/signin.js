                        ...
                        <div class="box is-radiusless is-shadowless">
                            ...
                            <div class="field">
                                ...
                                <p class="block control has-icons-left" v-bind:class="{ 'has-icons-right' : validator.hasInvalidField('signInPassword') }">
                                    <input class="input is-rounded" type="password" ref="signInPassword" required v-bind:class="{ 'is-danger': validator.hasInvalidField('signInPassword') }" v-bind:disabled="loading ? true: false" v-model="signInPassword" :placeholder="$t('signIn.labels.password')">
                        ...
                        <div class="box is-radiusless is-shadowless">
                            ...
                            <div class="field">
                                ...
                                <p class="block control has-icons-left" v-bind:class="{ 'has-icons-right' : validator.hasInvalidField('signUpPassword') }">
                                    <input class="input is-rounded" type="password" ref="signUpPassword" required v-bind:class="{ 'is-danger': validator.hasInvalidField('signUpPassword') }" v-bind:disabled="loading ? true: false" v-model="signUpPassword" :placeholder="$t('signIn.labels.password')">
                                    <span class="icon is-small is-left"><i class="fas fa-key"></i></span>
