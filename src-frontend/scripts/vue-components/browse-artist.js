...
import { mixinAPIError, mixinPagination, mixinLiveSearches, mixinArtists, mixinAlbums, mixinPlayer } from '../mixins.js';
...
export default {
    ...
    template: template(),
    mixins: [
        mixinAPIError, mixinPagination, mixinLiveSearches, mixinArtists, mixinAlbums, mixinPlayer
    ],
    data: function () {
        return ({
            loading: false,
