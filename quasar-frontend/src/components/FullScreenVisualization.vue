...
//import { default as FullScreenVisualizationSettings } from "components/FullScreenVisualizationSettings.vue";
...
function onSetShowFPS(v) {
  analyzer.value.setOptions({ showFPS: v });
}
