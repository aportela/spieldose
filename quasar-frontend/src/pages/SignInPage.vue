<template>
  <q-page class2="flex flex-center bg-grey-2">
    <div class="row items-center">
      <div class="col col-12 col-md-8 col-lg-6 col-xl-4 desktop-only">
        <q-card class="q-pa-md my_card no-border no-box-shadow">
      ...
      <div class="col col-8 lg-only container_tiles">
